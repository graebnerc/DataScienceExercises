...
```{r ex-addition-check}
grade_this({
  pass_if_equal(10+25, tolerance = 0.0001)  # 0.01% tolerance
})
```
...
grade_this({
  pass_if_equal(50*2, tolerance = 0.0001)  # 0.01% tolerance
})
```
...
```{r ex-division-check}
grade_this({
  pass_if_equal(27/4, tolerance = 0.0001)  # 0.01% tolerance
})
```
...
grade_this({
  pass_if_equal(500-650, tolerance = 0.0001)  # 0.01% tolerance
})
```
...
```{r ex-root-check}
grade_this({
  pass_if_equal(sqrt(3)*60, tolerance = 0.0001)  # 0.01% tolerance
})
```
...
```{r ex-chained-check}
grade_this({
  pass_if_equal(50*(4+2)**3, tolerance = 0.0001)  # 0.01% tolerance
})
```
...
grade_this({
  pass_if_equal(0.0002435549, tolerance = 0.00001)
})
```
