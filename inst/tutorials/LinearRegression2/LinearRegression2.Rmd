...
quiz(
  question(
    ...
    answer(paste0(
      "When some of the explanatory variables correlate strongsly with ",
      "each other.")),
    allow_retry = TRUE, random_answer_order = TRUE),
  question(
  ...
  question(paste("What is the main drawback of $\\bar{R}^2$ as compared to $R^2$?"),
    answer(paste0(
      ...
      correct = TRUE),
    answer(paste0(
      "You cannot interpret it as the share of explained variation in the ",
      "dependent variable."
      )),
    answer(paste0(
      "It becomes less precise the more independent variables are considered."
      )),
    answer(paste0(
...
grade_this({
  ...
  if(!str_detect(.user_code, "geom_parallel_slopes\\(se = FALSE\\)")){
