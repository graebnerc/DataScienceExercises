---
title: "Exercises 4: Visualization I"
author: "Introduction to data science: session 5"
...
quiz(
  ...
  question(
    ...
    answer(paste0(
      "For most geoms, there are some aesthetics that do not work,", 
      "but each aesthetic can be used to specify any geom.")),
    answer(paste0(
